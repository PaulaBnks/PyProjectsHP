    ...
    for idx, acc in enumerate(batch, 1):
        ...
        try:
            ...
            *  **Subheader 2:** Brief explanation or related points.
            ...
            - Always include all four headings (1. Key Themes, 2. Customer Concerns, 3. Prior Interactions, 4. Open Issues / Opportunities), even if there's little content.
            - Input text may be in **German**, **English**, or a mix of both. Always output the summary in **German**.
            - Output the summary in **German**, regardless of the language of the input text.
