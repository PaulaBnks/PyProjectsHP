...
def summarize_records(records, label, date_key='ActivityDate'):
    ...
    # Helper to extract and parse date safely
    def get_sort_date(record):
        ...
        if isinstance(raw_date, str):
            ...
            return datetime.min  # Use earliest possible date for missing data
...
query = """
    ...
    FROM Account 
    WHERE Account_Status__c = 'Prospect' AND CompanyType__c != 'Subcontractor' AND Temp__c = False Limit 200
"""

# query = """
#     SELECT Id, Name, AI_Summary__c 
#     FROM Account 
#     WHERE Id = '00109000013HnYDAA0'
# """
accounts = []
